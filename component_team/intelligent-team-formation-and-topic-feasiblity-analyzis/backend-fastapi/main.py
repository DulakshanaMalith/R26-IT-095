...
try:
    ...
    print(f"[OK] Data loaded successfully! Database contains {len(df_students)} student profiles.")
except Exception as e:
    print(f"[WARN] Error loading data: {e}. Make sure you ran preprocess.py!")
    df_students = None
...
try:
    ...
    print("[OK] Predictive Feasibility Model loaded successfully!")
except Exception as e:
