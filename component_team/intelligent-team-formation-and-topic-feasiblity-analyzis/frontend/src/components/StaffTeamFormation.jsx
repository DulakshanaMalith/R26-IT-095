  ...
  const paretoData = useMemo(
    () =>
      solutions.map((solution) => ({
        ...
        role: solution.role,
        technicalDeficit:
          solution.technical_requirement_deficit,
        preferenceDissatisfaction:
          solution.preference_dissatisfaction,
      })),
    [solutions]
  );
      ...
      {result && (
        <>
          <section className="mt-6 bg-slate-800/80 border border-slate-700 rounded-xl p-6">
            ...
            <div className="mt-6 h-80 bg-slate-900/70 border border-slate-700 rounded-xl p-4">
              <ResponsiveContainer
                width="100%"
                height="100%"
              >
